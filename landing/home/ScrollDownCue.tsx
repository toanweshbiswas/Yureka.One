  ...
  return (
    ...
    >
      ...
      <span
        ...
        style={{ width: 30, height: 50, border: '2px solid #def46e', paddingTop: 8 }}
      >
        <motion.span
          className="block rounded-full"
          style={{ width: 10, height: 10, background: '#def46e', boxShadow: '0 0 12px rgba(222,244,110,.8)' }}
          animate={{ y: [0, 16, 0], opacity: [1, 0.3, 1] }}
          transition={{ duration: 1.6, repeat: Infinity, ease: 'easeInOut' }}
        />
      </span>

      <span style={{ fontFamily: 'Inter, sans-serif', color: '#def46e', fontSize: 18, fontWeight: 500, letterSpacing: '-0.01em' }}>
        Keep Scrolling
      </span>
    </button>
  );
