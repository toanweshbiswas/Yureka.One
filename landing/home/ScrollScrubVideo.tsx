...
export default function ScrollScrubVideo({
  ...
  const card = (
    <div
      className={`relative mx-auto w-full max-h-full overflow-hidden rounded-2xl border border-white/10 bg-landing-ink ${className}`}
      style={{
        aspectRatio: '16 / 10',
        maxHeight: '100%',
  ...
  return (
    <div ref={trackRef} className="relative w-full" style={{ height: `${trackVh}vh` }}>
      <div
        className="sticky flex h-full w-full items-center justify-center px-4"
        style={{
      ...
      >
        ...
        {showScrollCue && (
          ...
          >
            ...
            />
            <span className="text-[10px] uppercase tracking-[0.3em] text-landing-muted">Keep Scrolling</span>
          </div>
        )}
      </div>
    </div>
