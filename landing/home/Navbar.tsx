...
const NAV_THEMES = {
  landing: {
    ...
    link: 'text-landing-sub hover:text-landing-primary',
    ...
    drawerDesc: 'text-landing-sub group-hover:text-landing-primary',
    drawerClose: 'text-landing-primary',
    statusDot: 'bg-landing-primary',
    statusText: 'text-landing-sub',
    hamburger: '#def46e',
  },
  site: {
    logo: 'text-white',
    link: 'text-white hover:text-landing-primary',
