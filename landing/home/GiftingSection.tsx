...
export default function GiftingSection() {
  ...
  return (
    <section id="gifting" className={`${landingSection} scroll-mt-24`}>
      <div className={landingContainer}>
        ...
        <p className={`mt-3 max-w-2xl ${landingBody}`}>
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-2xl bg-landing-primary py-3.5 text-[12px] font-bold uppercase tracking-[0.16em] text-landing-ink disabled:opacity-40 active:scale-[0.98]"
                >
                  {buying ? (
                    <>
