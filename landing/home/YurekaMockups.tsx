...
export function PhoneBubbleMockup() {
  return (
    <div className="relative flex h-full min-h-[260px] items-center justify-center overflow-hidden rounded-2xl border border-white/20 bg-landing-ink shadow-2xl shadow-black/40 backdrop-blur-xl">
